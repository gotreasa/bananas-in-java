...
application {
    mainClass.set("com.example.bananasinjava.App")
}
...
sonar {
    properties {
        ...
        property("sonar.links.scm", "https://github.com/gotreasa/bananas-in-java")
        property("sonar.projectKey", "gotreasa_bananas-in-java")
        property("sonar.organization", "gotreasa")
        property("sonar.projectName", "bananas-in-java")
